        ...
        <button className="request-call-back-btn my=4"   data-bs-toggle="modal" data-bs-target="#exampleModal">Request a Call Back</button>
{
 ...
 <div className="modal-dialog modal-dialog-centered" style={{ marginTop: '200px', height: '80%' }}>
  <div className="modal-content bg-dark-color text-white">
    ...
    <div className="modal-footer border-0">
      <button type="submit" className="btn btn-primary rounded-pill m-auto bg-white text-black">
        Request a callback
      </button>
    </div>
  </div>
  ...
  <div className="modal-dialog modal-dialog-centered modal-md mt-6">
    <div className="modal-content bg-dark text-white">
      <div className="modal-body text-center m-">
        ...
        <h6 style={{ color: '#808080' }} className="mb-4">Our Team will call you shortly in <br/>12-24 hrs</h6>
        <h6 style={{ color: '#808080' }}>Can’t you wait for a call?</h6>
      </div>
      <div className="modal-footer d-flex justify-content-center border-0">
        <button type="button" onClick={handleClick} className="btn btn-primary rounded-pill btn-wide">Check another video 👉</button>
      </div>
    </div>
  </div>
</div>
